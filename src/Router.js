    ...
    <App>
      <Suspense fallback={ <Loading /> }>
        <Switch>
          ...
          <PrivateRoute path={[ '/contacts/:pageId', '/contacts' ]} component={ Contacts } exact />
          <PrivateRoute path="/contact-details/:userId" component={ ContactDetails } exact />
          <PrivateRoute path="/contact-create" component={ ContactCreate } exact />
